    ...
    if decision == 'accept':
        ...
        <div style="background:#ddeeff;padding:40px 20px;font-family:Arial,sans-serif;">
          <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #b8d8f0;box-shadow:0 4px 24px rgba(30,100,180,0.10);">
            <div style="background:linear-gradient(135deg,#c8e8ff 0%,#fff8dc 100%);padding:26px 32px;border-bottom:2px solid #f4c430;">
              ...
              <h1 style="margin:6px 0 0;font-size:23px;color:#1a4a7a;font-weight:800;">Заявка одобрена! ✅</h1>
            </div>
            <div style="padding:28px 32px;background:#f5faff;">
              <p style="color:#2a6aa0;font-size:15px;margin:0 0 6px;">Привет, <span style="color:#1a4a7a;font-weight:700;">{nickname}</span>!</p>
              <p style="color:#5a8aaa;font-size:14px;margin:0 0 22px;">Твоя заявка принята. Остался один шаг — оплата проходки.</p>
              <div style="background:#ffffff;border:2px solid #f4c430;border-radius:14px;padding:20px 24px;margin-bottom:20px;box-shadow:0 2px 10px rgba(244,196,48,0.15);">
                <p style="margin:0 0 6px;font-size:11px;letter-spacing:2px;color:#b07d00;text-transform:uppercase;">Перевод</p>
                <p style="margin:0 0 10px;color:#5a8aaa;font-size:14px;">Переведи <span style="color:#1a4a7a;font-weight:700;">{AMOUNT} рублей</span> на карту:</p>
                <p style="margin:0;font-size:26px;font-weight:800;letter-spacing:4px;color:#c8960a;">{CARD_NUMBER}</p>
              </div>
              <p style="color:#8ab0cc;font-size:13px;margin:0;">После оплаты ты получишь доступ к серверу. Версия 1.21.11 · Карта 6000×6000</p>
            </div>
            <div style="padding:14px 32px;border-top:1px solid #ddeeff;text-align:center;background:#edf6ff;">
              <p style="margin:0;color:#9abcd4;font-size:11px;">Вопросы: @mXRlBLhQh · Discord: discord.gg/J5fcGEEM</p>
            </div>
          </div>
        </div>"""
        result_page = page(
        ...
        <div style="background:#ddeeff;padding:40px 20px;font-family:Arial,sans-serif;">
          <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #b8d8f0;box-shadow:0 4px 24px rgba(30,100,180,0.10);">
            <div style="background:linear-gradient(135deg,#c8e8ff 0%,#fff8dc 100%);padding:26px 32px;border-bottom:2px solid #f4c430;">
              <p style="margin:0;font-size:11px;letter-spacing:3px;color:#b07d00;text-transform:uppercase;">Spirit Server</p>
              <h1 style="margin:6px 0 0;font-size:23px;color:#1a4a7a;font-weight:800;">Заявка отклонена ❌</h1>
            </div>
            <div style="padding:28px 32px;background:#f5faff;">
              <p style="color:#2a6aa0;font-size:15px;margin:0 0 6px;">Привет, <span style="color:#1a4a7a;font-weight:700;">{nickname}</span>!</p>
              <p style="color:#5a8aaa;font-size:14px;margin:0 0 20px;">К сожалению, на этот раз твоя заявка не была одобрена.</p>
              <div style="background:#ffffff;border-left:4px solid #b8d8f0;border-radius:0 12px 12px 0;padding:16px 20px;box-shadow:0 2px 8px rgba(30,100,180,0.07);">
                <p style="margin:0;color:#5a8aaa;font-size:14px;line-height:1.6;">Не расстраивайся — ты можешь попробовать снова в следующий раз. Следи за обновлениями в наших соц. сетях.</p>
              </div>
            </div>
            <div style="padding:14px 32px;border-top:1px solid #ddeeff;text-align:center;background:#edf6ff;">
              <p style="margin:0;color:#9abcd4;font-size:11px;">Telegram: @mXRlBLhQh · Discord: discord.gg/J5fcGEEM</p>
            </div>
          </div>
        </div>"""
        result_page = page(
